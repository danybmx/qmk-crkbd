...
enum { TD_SEMI, TD_SLSH, TD_SIPE, TD_NARR, TD_UNDS, TD_EQQU };

enum custom_keycodes { M_ENHE = SAFE_RANGE, M_HARRW, M_EARRW };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_BASE] = LAYOUT_split_3x6_3(
                                                              ...
                                                              [_NUMBERS] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                                                                  KC_LCTL, KC_LALT, KC_LGUI, XXXXXXX, KC_CAPP, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PMNS, KC_PPLS,
                                                                  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                                                              ...
                                                              [_ADJUST] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                                                                  RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, KC_BRIU, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU, XXXXXXX,
                                                                  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
const rgblight_segment_t PROGMEM layer_numbers[] = RGBLIGHT_LAYER_SEGMENTS({0, 7, HSV_GREEN});
const rgblight_segment_t PROGMEM layer_symbols[] = RGBLIGHT_LAYER_SEGMENTS({27, 6, HSV_BLUE});                       // should be 27,7 but we're bypassing a led
const rgblight_segment_t PROGMEM layer_adjust[]  = RGBLIGHT_LAYER_SEGMENTS({0, 7, HSV_PURPLE}, {27, 6, HSV_PURPLE}); // should be 27,7 but we're bypassing a led

const rgblight_segment_t *const PROGMEM my_rgb_layers[] = RGBLIGHT_LAYERS_LIST(layer_numbers, layer_symbols, layer_adjust);
